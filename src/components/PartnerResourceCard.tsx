...
export default function PartnerResourceCard() {
  return (
    <section className="card partner-card partner-top-card" aria-labelledby="partner-resource-title">
      ...
      <a className="btn partner-btn" href={SHOP_URL} target="_blank" rel="noopener noreferrer">
        查看店铺 ↗
      </a>
    </section>
  );
